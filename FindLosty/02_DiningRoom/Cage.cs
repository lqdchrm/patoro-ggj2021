    ...
    public class Cage : Container
    {
        ...
        */
        public override void Open(IPlayer sender)
        {
            string message = "";
            IThing thing;
            bool hamster_found = TryFind("hamster", out thing, false, false);
            if (thing is Hamster hamster)
            {
                message = $"There was a {hamster} in the {this}.... and you just let it out... Great.";
                sender.Room.BroadcastMsg($"{sender} opened the {this}. Now there is a {hamster} loose.\nEveryone sighs.\nGreat job {sender}.", sender);
                this.Transfer(hamster, Game.DiningRoom);
                hamster.person_that_let_hamster_go = sender;
            }
            else
            {
                message = $"You open the cage and... nothing.";
            }
