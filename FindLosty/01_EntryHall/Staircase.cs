...
namespace LostAndFound.FindLosty._01_EntryHall
{
    public class Staircase : Thing
    {
        ...
        ╚══════╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═╝
        */
        public override string LookText => isBroken
            ? @$"
...
".FormatMultiline());
                ...
                Game.DiningRoom.SendText(@$"
You hear a load noise. Something seems to be collapsed in the {Game.EntryHall}.
");
                Game.LivingRoom.SendText(@$"
You hear a load noise. Something seems to be collapsed in the {Game.EntryHall}.
");
                Game.Kitchen.SendText(@$"
